...
const TopClasses = () => {
  ...
  return (
    <div className=" maxWidth mx-auto parallel relative overflow-x-hidden flex py-32 gap-20 justify-between items-center px-4 md:px-12 md:flex-row  flex-col">
      <div className="h-full w-full bg-[rgba(0,0,0,.5)] absolute top-0 right-0 z-0" ></div>
      <div className="relative w-[12rem] h-[12rem] mx-auto md:ms-auto z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 md:w-4/5 w-full z-10">
      {
