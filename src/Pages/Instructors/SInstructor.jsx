    ...
    return (
        <div className="w-[21rem] cardIns">
            <div className="w-full">
                <div className="h-fit p-4 mx-auto relative imgbg rounded-full z-10 bg-base-100 -mb-[3.4rem] w-3/5 ">
                <img className="max-h-[9rem] rounded-full  insImage" src={photo} alt="" />
                </div>
            </div>
            <div className="px-6 pt-[4.5rem] text-gray-200 pb-6 border-2 z-0 bg-[#8e6e35]  rounded-2xl font2">
