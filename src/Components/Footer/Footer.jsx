...
const Footer = () => {
  return (
    <div>
      <footer className="footer p-10 justify-around bg-[#d2c2a6] text-base-content">
        <div>
      ...
      <footer className="footer px-10 py-4 border-t bg-[#d2c2a6] text-base-content items-center border-base-300">
